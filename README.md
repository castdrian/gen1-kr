...
- A / Return: scanner
- B / Space: turbo boost
- C: switch KITT; hold C: KARR mode
- S: ski mode
- X: KITT 3000 attack mode

On touch devices, use the car, ski, and attack controls beside the game buttons. Hold the car control for KARR mode.
