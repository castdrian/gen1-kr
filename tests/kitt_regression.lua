...
assert(source:find("progress < 0.25", 1, true))
assert(source:find("requestSkiMode", 1, true))
assert(source:find('key == "s"', 1, true))
assert(source:find("ATTACK_TRANSFORM_FILE", 1, true))
assert(source:find("ATTACK_TRANSFORM_DURATION = 5.02", 1, true))
assert(source:find("requestAttackMode", 1, true))
assert(source:find('key == "x"', 1, true))
assert(source:find("assets/kitt-3000-attack-model.lua", 1, true))
assert(source:find("playVoice", 1, true))
